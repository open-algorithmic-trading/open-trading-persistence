INSERT INTO stock (symbol, name, industry) VALUES
    ...
    ('ANR','Alpha Natural Resources','Energy'),
    ...
    ('APOL','Apollo Group Inc','Consumer Discretionary'),
    ...
    ('BEAM','Beam Inc.','Consumer Discretionary'),
    ...
    ('BIG','Big Lots Inc.','Consumer Discretionary'),
    ('BIIB','BIOGEN IDEC Inc.','Health Care'),
    ('BLK','BlackRock','Financials'),
    ('HRB','Block H&R','Consumer Discretionary'),
    ('BMC','BMC Software','Information Technology'),
    ...
    ('BRCM','Broadcom Corporation','Information Technology'),
    ...
    ('CBE','Cooper Industries','Industrials'),
    ('GLW','Corning Inc.','Industrials'),
    ('COST','Costco Co.','Consumer Staples'),
    ('CVH','Coventry Health Care Inc.','Health Care'),
    ('COV','Covidien plc','Health Care'),
    ('CCI','Crown Castle International Corp.','Telecommunications Services'),
    ...
    ('DV','DeVry, Inc.','Consumer Discretionary'),
    ('DO','Diamond Offshore Drilling','Energy'),
    ('DTV','DirecTV','Consumer Discretionary'),
    ('DFS','Discover Financial Services','Financials'),
    ('DISCA','Discovery Communications','Consumer Discretionary'),
    ('DLTR','Dollar Tree','Consumer Discretionary'),
    ('D','Dominion Resources','Utilities'),
    ('RRD','Donnelley (R.R.) & Sons','Industrials'),
    ...
    ('FII','Federated Investors Inc.','Financials'),
    ...
    ('FHN','First Horizon National','Financials'),
    ('FSLR','First Solar Inc','Industrials'),
    ...
    ('FOSL','Fossil, Inc.','Consumer Discretionary'),
    ...
    ('GOOG','Google Inc.','Information Technology'),
    ...
    ('HCN','Health Care REIT','Financials'),
    ('HNZ','Heinz (H.J.)','Consumer Staples'),
    ...
    ('HCBK','Hudson City Bancorp','Financials'),
    ...
    ('ICE','IntercontinentalExchange Inc.','Financials'),
    ...
    ('JBL','Jabil Circuit','Information Technology'),
    ('JEC','Jacobs Engineering Group','Industrials'),
    ('JDSU','JDS Uniphase Corp.','Information Technology'),
    ('JNJ','Johnson & Johnson','Health Care'),
    ('JCI','Johnson Controls','Consumer Discretionary'),
    ('JOY','Joy Global Inc.','Industrials'),
    ...
    ('KFT','Kraft Foods Inc-A','Consumer Staples'),
    ...
    ('LXK','Lexmark Int''l Inc','Information Technology'),
    ('LIFE','Life Technologies','Health Care'),
    ...
    ('LO','Lorillard Inc.','Consumer Staples'),
    ('LOW','Lowe''s Cos.','Consumer Discretionary'),
    ('LSI','LSI Corporation','Information Technology'),
    ...
    ('NBR','Nabors Industries Ltd.','Energy'),
    ...
    ('NWSA','News Corporation','Consumer Discretionary'),
    ('NEE','NextEra Energy Resources','Utilities'),
    ('NKE','NIKE Inc.','Consumer Discretionary'),
    ('NI','NiSource Inc.','Utilities'),
    ('NE','Noble Corp','Energy'),
    ...
    ('NU','Northeast Utilities','Utilities'),
    ('NRG','NRG Energy','Utilities'),
    ('NUE','Nucor Corp.','Materials'),
    ('NVDA','Nvidia Corporation','Information Technology'),
    ('NYX','NYSE Euronext','Financials'),
    ...
    ('JCP','Penney (J.C.)','Consumer Discretionary'),
    ('PBCT','People''s United Bank','Financials'),
    ('POM','Pepco Holdings Inc.','Utilities'),
    ...
    ('PCL','Plum Creek Timber Co.','Financials'),
    ...
    ('PCP','Precision Castparts','Industrials'),
    ('PCLN','Priceline.com Inc','Industrials'),
    ...
    ('SWY','Safeway Inc.','Consumer Staples'),
    ('SAI','SAIC','Information Technology'),
    ...
    ('SHLD','Sears Holdings Corporation','Consumer Discretionary'),
    ...
    ('SLM','SLM Corporation','Financials'),
    ...
    ('S','Sprint Nextel Corp.','Telecommunications Services'),
    ...
    ('TIE','Titanium Metals Corp','Materials'),
    ...
    ('X','United States Steel Corp.','Materials'),
    ...
    ('WIN','Windstream Corporation','Telecommunications Services'),
    ('WEC','Wisconsin Energy Corporation','Utilities'),
    ('WPX','WPX Energy, Inc.','Energy'),
